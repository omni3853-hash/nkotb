...
function MediaStatsCards({ items }: { items: RememberBettyMedia[] }) {
...
function EditMediaForm({
    ...
    defaultValues: RememberBettyMedia;
    onSubmit: (data: MediaFormValues) => void;
    submitting: boolean;
    onCancel: () => void;
}) {
...
export default function ManageMediaPage() {
    ...
    const [selected, setSelected] = useState<RememberBettyMedia | null>(null);
    ...
    const loadMedia = async () => {
        try {
            setLoading(true);
            const res: Paginated<RememberBettyMedia> = await RememberBettyMediaApi.list({
                page,
                limit,
        ...
        setConfirm({
            ...
            onYes: async () => {
                try {
                    ...
                    const created = await RememberBettyMediaApi.create({
                        title: data.title,
    ...
    const startEdit = (item: RememberBettyMedia) => {
        setSelected(item);
        setEditOpen(true);
    };
        ...
        setConfirm({
            ...
            onYes: async () => {
                try {
                    ...
                    const updated = await RememberBettyMediaApi.update(selected._id, {
                        title: data.title,
                        category: data.category,
                        mediaUrl: data.mediaUrl,
                    });
    ...
    const removeMedia = (item: RememberBettyMedia) => {
        setConfirm({
            open: true,
            tone: "danger",
            ...
            onYes: async () => {
                try {
                    await RememberBettyMediaApi.remove(item._id);
    ...
    const shareMedia = async (item: RememberBettyMedia) => {
