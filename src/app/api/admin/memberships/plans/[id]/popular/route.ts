...
import { setMembershipPlanPopularController } from "@/lib/controllers/membershipPlan.controller";
...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        return await setMembershipPlanPopularController(req as any, { params });
    } catch (e) {
