...
import { setDefaultPaymentMethodController } from '@/lib/controllers/paymentMethod.controller';
...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        return await setDefaultPaymentMethodController(req as any, { params });
    } catch (error) {
